...
_C.MODEL.RESNETS.STEM_3X3X3 = False
_C.MODEL.RESNETS.STEM_AA = True
_C.MODEL.RESNETS.STEM_NO_MAXPOOL = False
_C.MODEL.RESNETS.BOTTLENECK_AA = False
...
_C.FROZEN_ONNX = False

_C.RADAM_OPTIMIZER = False

# ---------------------------------------------------------------------------- #
# DeepShift options
# ---------------------------------------------------------------------------- #
_C.DEEPSHIFT_DEPTH = 1000
# 'PS' 'Q'
_C.DEEPSHIFT_TYPE = 'PS'
# 'deterministic', 'stochastic'
_C.DEEPSHIFT_ROUNDING = 'deterministic' 
_C.DEEPSHIFT_RANGE = (-15, 0)
_C.DEEPSHIFT_USEKERNEL = False
_C.MODEL.WEIGHT_DEEPSHIFT = ''

...
import fcos_core.deepshift.ste as ste
...
class LinearShiftFunction(Function):
    ...
    def forward(ctx, input, shift, sign, bias=None, conc_weight=None, use_kernel=False, use_cuda=True, rounding='deterministic', shift_range=(-15, 0)):
        fraction_bits = 16
        integer_bit = 16
...
class LinearShift(nn.Module):
    def __init__(self, in_features, out_features, bias=True, check_grad=False, freeze_sign=False, use_kernel=False, use_cuda=True, rounding='deterministic', shift_range=(-15, 0)):
        ...
        # we use ternary weights to represent sign
...
class Conv2dShiftFunction(Function):
    ...
    @staticmethod
    # bias is an optional argument
    def forward(ctx, input, shift, sign, bias=None, conc_weight=None, stride=1, padding=0, dilation=1, groups=1, use_kernel=False, use_cuda=False, rounding='deterministic', shift_range=(-15,0)):
        fraction_bits = 16
        integer_bits = 16
        ...
        if use_kernel:
            ...
            out = fcos_core.deepshift.kernels.conv2d(input_fixed_point, shift, sign, bias_fixed_point, conc_weight, stride, padding, dilation, groups, use_cuda)
...
class _ConvNdShift(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride,
                 ...
                 rounding='deterministic', shift_range=(-15, 0)):
...
class Conv2dShift(_ConvNdShift):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 ...
                 check_grad=False, freeze_sign=False, use_kernel=False, use_cuda=True, rounding='determinstic', shift_range=(-15, 0)):
        ...
        super(Conv2dShift, self).__init__(
            ...
            check_grad, freeze_sign, rounding, shift_range)

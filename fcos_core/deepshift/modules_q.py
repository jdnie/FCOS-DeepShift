...
class LinearShiftQ(nn.Module):
    def __init__(self, in_features, out_features, bias=True, check_grad=False, use_kernel=False, use_cuda=True, rounding='deterministic', shift_range=(-15, 0)):

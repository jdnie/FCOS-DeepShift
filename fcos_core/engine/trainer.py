...
def do_train(
    ...
    for iteration, (images, targets, _) in enumerate(data_loader, start_iter):
        ...
        # 训练resnest时，有时很奇怪batch=1导致训练停止
        if len(images.tensors) == 1:
            logger.info("!!!!!!!!images.tensors {}".format(len(images.tensors)))
            continue
        ...
        # debug the no used params, which cause distribute training failed
        # if iteration == 10:

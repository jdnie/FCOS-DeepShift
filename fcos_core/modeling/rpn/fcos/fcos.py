...
class FCOSHead(torch.nn.Module):
    def __init__(self, cfg, in_channels):
        ...
        for i in range(cfg.MODEL.FCOS.NUM_CONVS):
            ...
            if cfg.MODEL.FCOS.USE_BN:
                cls_tower.append(nn.BatchNorm2d(in_channels))
            # elif cfg.MODEL.FCOS.USE_GN_UNOFFICIAL:
            #    cls_tower.append(GroupBatchnorm2d(min(32, in_channels//2), in_channels))
            else:
            ...
            # elif cfg.MODEL.FCOS.USE_GN_UNOFFICIAL:
            #    bbox_tower.append(GroupBatchnorm2d(min(32, in_channels//2), in_channels))
            else:
...
class FCOSModule(torch.nn.Module):
    ...
    def __init__(self, cfg, in_channels):
        ...
        self.fpn_strides = cfg.MODEL.FCOS.FPN_STRIDES
        self._frozen_onnx = cfg.FROZEN_ONNX
